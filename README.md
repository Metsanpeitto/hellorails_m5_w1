...
- [`git clone https://github.com/Metsanpeitto/hellorails_m5_w1`](https://github.com/Metsanpeitto/hellorails_m5_w1)


### Setup

```cmd
git clone  https://github.com/Metsanpeitto/hellorails_m5_w1.git
cd ./hellorails_m5_w1
```
